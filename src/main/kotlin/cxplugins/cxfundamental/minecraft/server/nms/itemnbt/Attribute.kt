 ...
 */
class AttributeModifier(name:String, amount:Double, attribute:ItemAttribute, operation:AttributeOperation=AttributeOperation.ADD_NUMBER, slot:ItemSlot=ItemSlot.INVENTORY,uuidLeast:Long=Random().nextLong(),uuidMost:Long=uuidLeast+Math.abs(Random().nextLong())){
    /**
     * 这个属性的名字
     */
