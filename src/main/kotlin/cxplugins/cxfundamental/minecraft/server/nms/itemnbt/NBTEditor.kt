...
object NBTEditor {
    ...
    fun setValueInCompound(compound:Any,value:Any?,vararg compoundPath:String){
        if(compoundPath.size<=1){
            ...
            if(hasKeyInCompound(compound,compoundPath[0])){
                ...
                setValueInCompound(newCompound,value,*compoundPath.toList().subList(1,compoundPath.size).toTypedArray())
    ...
    fun getItemAttributeModifiers(itemStack: ItemStack):List<AttributeModifier>{
        ...
        var modifiers=if(NBTTagCompound.hasKey(mainCompound,"AttributeModifiers")) NBTTagCompound.get(mainCompound,"AttributeModifiers")
        else {
            return emptyList()
        }
        ...
        for(i in 0..modifierAmount){
            ...
            if(NBTTagCompound.hasKey(compound,"AttributeName")){
                attributeModifier.attribute=ItemAttribute.getValueFromString(NBTTagCompound.getString(compound,"AttributeName") as String)!!
            }
            ...
            if(NBTTagCompound.hasKey(compound,"Operation")){
                attributeModifier.operation= AttributeOperation.getValueFromTypeId((NBTTagCompound.getInt(compound,"Name") as Int).toShort())!!
            }
            ...
            if(NBTTagCompound.hasKey(compound,"Slot")){
                attributeModifier.slot=ItemSlot.getValueFromString(NBTTagCompound.getString(compound,"Slot") as String)!!
            }
    ...
    fun setItemAttribute(itemStack: ItemStack,modifier: AttributeModifier):ItemStack{
        ...
        var modifers=if(NBTTagCompound.hasKey(mainCompound,"AttributeModifiers")) NBTTagCompound.get(mainCompound,"AttributeModifiers")
        else NBTTagList.constructor.newInstance()
        var modiferCompound=NBTTagCompound.constructor.newInstance()
        NBTTagCompound.set(modiferCompound,"AttributeName",NBTTagString.constructor.newInstance(modifier.attribute.attributeName))
    ...
    fun getMethods() {
        ...
        NBTTagCompound.setBoolean = NBTTagCompound.clazz!!.getMethod("setBoolean", String::class.java, Boolean::class.javaPrimitiveType)
        NBTTagCompound.setByte = NBTTagCompound.clazz!!.getMethod("setByte", String::class.java, Byte::class.javaPrimitiveType)
        NBTTagCompound.setByteArray = NBTTagCompound.clazz!!.getMethod("setByteArray", String::class.java, ByteArray::class.java)
        NBTTagCompound.setDouble = NBTTagCompound.clazz!!.getMethod("setDouble", String::class.java, Double::class.javaPrimitiveType)
        NBTTagCompound.setFloat = NBTTagCompound.clazz!!.getMethod("setFloat", String::class.java, Float::class.javaPrimitiveType)
        NBTTagCompound.setInt = NBTTagCompound.clazz!!.getMethod("setInt", String::class.java, Int::class.javaPrimitiveType)
        NBTTagCompound.setIntArray = NBTTagCompound.clazz!!.getMethod("setIntArray", String::class.java, IntArray::class.java)
        NBTTagCompound.setLong = NBTTagCompound.clazz!!.getMethod("setLong", String::class.java, Long::class.javaPrimitiveType)
        NBTTagCompound.setShort = NBTTagCompound.clazz!!.getMethod("setShort", String::class.java, Short::class.javaPrimitiveType)
